...
#### Basic Tools :
  ...
  * [Pexels - Images](https://www.pexels.com/)
    ![Pexels](https://github.com/tactlabs/wiki/blob/master/images/pexels.png?raw=true)

  * [Credit Card Generator](https://generator-credit-card.com/)
    ![Credit Card Generator](https://github.com/tactlabs/wiki/blob/master/images/creditcard-generator.png?raw=true)
